...
class PeersViewController: UITableViewController {
    ...
    override func viewWillDisappear(_ animated: Bool) {
        NotificationCenter.default.removeObserver(self, name: NSNotification.Name.CupLinkPeersUpdated, object: nil)
    }
    ...
    override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        switch section {
        case 0: return app.CupLinkPeers.count
        case 1:
    ...
    override func tableView(_ tableView: UITableView, titleForFooterInSection section: Int) -> String? {
        switch section {
        case 1:
            return "CupLink will automatically attempt to connect to configured peers when started. If you configure more than one peer, your device may carry traffic on behalf of other network nodes. Avoid this by configuring only a single peer."
        case 2:
    ...
    @IBAction func addNewPeerButtonPressed(_ sender: UIBarButtonItem) {
        let alert = UIAlertController(title: "Add Configured Peer", message: """
            Enter the full URI of the peer to add. CupLink will automatically connect to this peer when started.
